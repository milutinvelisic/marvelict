window.onload = function () {
    ...
    if (url.indexOf("avengers.html") != -1) {
        hederLista()
        footerListe()
        footerInfoSlika()
        avengersAjax()
    ...
    if (url.indexOf("fantastic-four.html") != -1) {
        hederLista()
        footerListe()
        footerInfoSlika()
        f4Ajax()
    ...
    if (url.indexOf("tv-shows.html") != -1) {
        hederLista()
        footerListe()
        footerInfoSlika()
        slikeNewsBlock()
